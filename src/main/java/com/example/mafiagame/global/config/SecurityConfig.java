...
public class SecurityConfig {
        ...
        @Value("${mafiagame.security.dev-endpoints-enabled:false}")
                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> {
                                        ...
                                        if (isDevEndpointAccessAllowed()) {
                                                auth.requestMatchers("/h2-console/**", "/api/test/**").permitAll();
                                        } else {
                                                auth.requestMatchers("/h2-console/**", "/api/test/**").denyAll();
                                        }
        ...
        private boolean isDevEndpointAccessAllowed() {
                return devEndpointsEnabled || environment.acceptsProfiles(Profiles.of("dev", "test"));
        }
}
